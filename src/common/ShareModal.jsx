...
const ShareModal = ({ openSharModal, handleClose, referralID }) => {
  const [userType, setUserType] = useState("");
  const state = localStorage.getItem("stateHandlerId");
  const franchise = localStorage.getItem("frenchiseId");

  const shareUrl = "https://business.jettradefx.in/";
